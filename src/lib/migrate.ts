...
const ALTER_TABLE_SQL = [
  ...
  `ALTER TABLE "Settings" ADD COLUMN "resendEnabled" INTEGER NOT NULL DEFAULT 0`,
  `ALTER TABLE "Settings" ADD COLUMN "resendApiKey" TEXT NOT NULL DEFAULT ''`,
  `ALTER TABLE "Settings" ADD COLUMN "resendDomain" TEXT NOT NULL DEFAULT ''`,
...
const MIGRATION_SQL = [
  ...
  `CREATE TABLE "Settings" (
    ...
    "resendEnabled" INTEGER NOT NULL DEFAULT 0,
    "resendApiKey" TEXT NOT NULL DEFAULT '',
    "resendDomain" TEXT NOT NULL DEFAULT '',
